 ...
 * |--------+------+------+------+------+------| Lock |           | App  |------+------+------+------+------+--------|
 * | LShift |   Z  |   X  |   C  |   V  |   B  |      |           |      |   N  |   M  |   ,  |   .  | UP.  |//Ctr   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  Win |Alt   | [    |   ]  |                                        | [   |    ] | LEFT | DOWN| RIGHT    |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 ...
 */
    ...
    [BASE] = LAYOUT_ergodox( // layer 0 : default
        ...
        ALT_T(KC_APP), KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, KC_SLSH,
        KC_LBRC, KC_RBRC, KC_LEFT, KC_DOWN, KC_RGHT,
        TO(BASE), KC_ESC,
        KC_PGUP,
        KC_PGDN, KC_ENT, KC_SPC),
    /* Keymap 1: Symbol Layer (BASE)
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  opt | Cmd  | [    |   ]  |                                        |[    | ]    | LEFT | DOWN| RIGHT  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
